...
class SequencePredictor(Model):
    ...
    def add_prediction_op(self):
        ...
        preds = tf.nn.dynamic_rnn(cell, x, dtype=tf.float32)[1] # state: [batch_size * state_size]
    ...
    def add_training_op(self, loss):
        ...
        if self.config.clip_gradients:
            gradients, _ = tf.clip_by_global_norm(gradients, self.config.max_grad_norm) # return (list_cliped, global_norm)
