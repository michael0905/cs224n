...
class RNNModel(NERModel):
    ...
    def add_prediction_op(self):
        ...
        U = tf.get_variable('U', [Config.hidden_size, Config.n_classes], initializer=xav)
        b_2 = tf.get_variable('b_2', [Config.n_classes], initializer=xav)
        ...
        with tf.variable_scope("RNN"):
            for time_step in range(self.max_length):
                ...
                o, h = cell(inputs=x[:,time_step,:], state=h, scope="RNN")
