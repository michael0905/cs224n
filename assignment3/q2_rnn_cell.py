...
class RNNCell(tf.contrib.rnn.BasicRNNCell):
    ...
    def __call__(self, inputs, state, scope=None):
        ...
        with tf.variable_scope(scope):
            ...
            W_x = tf.get_variable('W_x', [self.input_size, self._state_size], initializer=xav)
            W_h = tf.get_variable('W_h', [self._state_size, self._state_size], initializer=xav)
            b = tf.get_variable('b', [self._state_size], initializer=xav)
